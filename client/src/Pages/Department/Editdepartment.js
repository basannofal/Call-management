...
const Editdepartment = () => {
  ...
  const getPerDepartment = async (id) => {
    try {
      const res = await axios.get(
        `${process.env.REACT_APP_PROXY_URL}/getperdepartment/${location.state.id}`
      );
      setDepartmentName(res.data[0].department_name);
      setDepartmentEmail(res.data[0].department_email);
      setDepartmentContact(res.data[0].department_contact);
  ...
  const editdata = async (e) => {
    ...
    if (
      ...
      try {
        await axios
          .put(
            `${process.env.REACT_APP_PROXY_URL}/editdepartment/${location.state.id}`,
            group
          )
          .then((res) => {
            console.log(res);
              ...
              <div id="content">
                ...
                <div className="container-fluid">
                  ...
                  <div className="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 className="h3 mb-0 text-gray-bold">Deparment</h1>
                  </div>
                        ...
                        >
                          <form onSubmit={editdata}>
                            <div class="form-group">
                              <label for="name">Deparment ID</label>
                              <input
                                type="text"
                                class="form-control"
                                value={id}
